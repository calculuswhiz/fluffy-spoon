...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bytesline = QtWidgets.QLineEdit(self.layoutWidget)
        self.bytesline.setStyleSheet("color:rgb(85, 87, 83)")
        self.bytesline.setReadOnly(True)
        self.bytesline.setObjectName("bytesline")
        self.gridLayout.addWidget(self.bytesline, 9, 0, 1, 2)
        self.label_3 = QtWidgets.QLabel(self.layoutWidget)
        self.label_3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 5, 1, 1, 1)
        self.v1ack_btn = QtWidgets.QPushButton(self.layoutWidget)
        self.v1ack_btn.setObjectName("v1ack_btn")
        self.gridLayout.addWidget(self.v1ack_btn, 5, 0, 1, 1)
        self.openGC = QtWidgets.QPushButton(self.layoutWidget)
        self.openGC.setObjectName("openGC")
        self.gridLayout.addWidget(self.openGC, 9, 2, 1, 1)
        self.scrollArea = QtWidgets.QScrollArea(self.centralwidget)
        self.scrollArea.setGeometry(QtCore.QRect(10, 240, 521, 321))
        ...
        self.calcTable.setGeometry(QtCore.QRect(0, 0, 521, 321))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.acq_btn.setText(_translate("MainWindow", "&Acquire"))
        self.calc_btn.setText(_translate("MainWindow", "Re&calculate"))
        ...
        self.bytesline.setText(_translate("MainWindow", "07 28 90 24 00 14 10 00 00"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p>Angle:</p></body></html>"))
        self.v1ack_btn.setText(_translate("MainWindow", "Ac&quire v1"))
        self.openGC.setText(_translate("MainWindow", "Open GC"))
