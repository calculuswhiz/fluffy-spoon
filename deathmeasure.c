/* build command: "gcc -o deathmeasure deathmeasure.c -L/usr/X11R6/lib -lX11" */
/* This program was modified from original program "xmeasure" for linux. */
/*
